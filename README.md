...
This repository sets up a LibreChat + LiteLLM application with Palo Alto Networks AIRS integration. It is intended to provide an easily accessible solution to try AIRS with different models.
...
# Clone GIT repo
git clone https://github.com/jansvensen/panw-airs-lab-runtime-litellm.git

# Change to the repo directory
cd panw-airs-lab-runtime-litellm
```
